    ...
    return (
        <div id="about" className="about-wraper">
            ...
            <div className="about-info">
                ...
                <h3 className="about-intro-heading">I'am Suresh Suthar<h5 className="about-para">I love to design and develop web and mobile based application. Right now i m pursuing my MCA(Master Of Computer Application) degree in Computer Science from MIT World Peace University. My portfolio is a representation of all that I've learned and
